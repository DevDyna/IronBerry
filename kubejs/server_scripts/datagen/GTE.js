ServerEvents.highPriorityData(event => {
    ...
    [
        'blaze_gate','blaze_gate_large','blaze_gate_small','creeper_gate','creeper_gate_large','creeper_gate_small','enderman_gate','enderman_gate_large','enderman_gate_small','ghast_gate','ghast_gate_large','ghast_gate_small','magma_cube_gate','magma_cube_gate_large','magma_cube_gate_small','shulker_gate','shulker_gate_large','shulker_gate_small','skeleton_gate','skeleton_gate_large','skeleton_gate_small','slime_gate','slime_gate_large','slime_gate_small','spider_gate','spider_gate_large','spider_gate_small','witch_gate','witch_gate_large','witch_gate_small','zombie_gate','zombie_gate_large','zombie_gate_small',
    ].forEach(data => {
        event.addJson(`gateways:gateways/${data}`, {})
    })

	//made for Ironberry Modpack
    event.addJson(`gateways:gateways/simple_gate`, {
        "size": "medium",
        "color": "#FFFF84",
        "waves": [{
                "entities": [{
                ...
                "rewards": [{
                        "type": "loot_table",
                        "loot_table": "ironberry:gateway/simple_loot",
                        "rolls": 1,
                        "desc": "Loot Simple"
                    }
                ],
        ...
        "rewards": [{
                "type": "loot_table",
                "loot_table": "ironberry:gateway/reward",
                "rolls": 1,
                "desc": "Loot Reward"
            }, {
                "type": "loot_table",
