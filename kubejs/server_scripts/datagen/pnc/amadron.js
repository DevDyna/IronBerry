...
*/
  ...
  nbt_trade(
    ...
    "minecraft:bee_nest",
    1,
    '{BlockEntityTag:{Bees:[{EntityData:{id:"minecraft:bee"}},{EntityData:{id:"minecraft:bee"}}]},display:{Lore:[\'{"text":"This bee nest have 2 bees","color":"gold"}\']}}',
    false
  );
