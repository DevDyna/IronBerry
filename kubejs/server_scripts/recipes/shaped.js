...
event.shaped(Item.of('gateways:gate_pearl', '{gateway:"gateways:battle_gate_large"}'), [
	...
	shapex(['pneumaticcraft:upgrade_matrix', 'pneumaticcraft:module_expansion_card', 'pneumaticcraft:upgrade_matrix', 'pneumaticcraft:module_expansion_card','pneumaticcraft:compressed_iron_boots', 'pneumaticcraft:module_expansion_card', 'pneumaticcraft:upgrade_matrix', 'pneumaticcraft:module_expansion_card', 'pneumaticcraft:upgrade_matrix'],'pneumaticcraft:pneumatic_boots')
	shapex(['pneumaticcraft:upgrade_matrix', 'pneumaticcraft:module_expansion_card', 'pneumaticcraft:upgrade_matrix', 'pneumaticcraft:module_expansion_card','pneumaticcraft:compressed_iron_leggings', 'pneumaticcraft:module_expansion_card', 'pneumaticcraft:upgrade_matrix', 'pneumaticcraft:module_expansion_card', 'pneumaticcraft:upgrade_matrix'],'pneumaticcraft:pneumatic_leggings')
