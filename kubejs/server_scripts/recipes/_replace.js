ServerEvents.recipes((event) => {
  ...
  event.replaceInput(
    { output: "#exoticbirds:birdcages" },
    "minecraft:oak_slab",
    "#minecraft:wooden_slabs"
  );
  event.replaceInput(
    { input: "#ironberry:tables" },
    "minecraft:crafting_table",
    "#ironberry:tables"
  );
  event.replaceInput(
    { input: "cyclic:compressed_cobblestone" },
  ...
  //silicon saw change
  event.replaceInput(
    { input: "bluepower:diamond_saw" },
    "bluepower:diamond_saw",
    "bluepower:iron_saw"
  );
  ...
  //rootsclassic
  event.replaceInput(
    { output: "rootsclassic:attuned_standing_stone" },
    "minecraft:diamond",
  ...
  event.replaceInput(
    { output: "bluepower:project_table" },
    "#forge:stone",
    "#forge:ingots/iron"
  );
  ...
  event.replaceInput(
    { output: "exoticbirds:egg_identifier" },
    "minecraft:glass",
    "minecraft:iron_bars"
  );
  event.replaceInput(
    { output: "exoticbirds:egg_incubator" },
    "minecraft:glass",
    "minecraft:iron_bars"
  );
  ...
  //tanzanite
  event.replaceInput(
    { input: "bluepower:amethyst_gem" },
    "bluepower:amethyst_gem",
    "minecraft:amethyst_shard"
  );
  event.replaceOutput(
    { output: "bluepower:amethyst_gem" },
    "bluepower:amethyst_gem",
    "minecraft:amethyst_shard"
  );

  event.replaceInput(
    { output: "bluepower:amethyst_block" },
    "minecraft:amethyst_shard",
    "bluepower:amethyst_gem"
  );
  event.replaceOutput(
    { input: "bluepower:amethyst_block" },
    "minecraft:amethyst_shard",
    "bluepower:amethyst_gem"
  );
  ...
  event.replaceInput(
    { output: "integrateddynamics:energy_battery" },
    "minecraft:redstone_block",
    "bluepower:battery_block"
  );
  event.replaceInput(
    { output: "integrateddynamics:part_extradimensional_reader" },
    "minecraft:ender_pearl",
    "reactive:stardust"
  );
  event.replaceInput(
  ...
  event.replaceInput(
    { output: "integrateddynamics:delay" },
    "minecraft:clock",
    "integrateddynamics:logic_director"
  );
  event.replaceInput(
    { output: "integratednbt:nbt_extractor_remote" },
    "minecraft:ender_pearl",
    "integratednbt:nbt_extractor"
  );
  event.replaceInput(
    { output: "integrateddynamics:part_world_reader" },
    "minecraft:obsidian",
    "minecraft:coarse_dirt"
  );

  event.replaceInput(
    { output: "integrateddynamics:enhancement_offset" },
  ...
  event.replaceInput(
    { output: "integrateddynamics:part_effect_writer" },
    "minecraft:fire_charge",
    "supplementaries:soap"
  );
  event.replaceInput(
    { output: "integrateddynamics:part_entity_reader" },
    "minecraft:porkchop",
    "#ironberry:sticky"
  );
  ...
  event.replaceInput(
    { output: "ars_nouveau:scryers_crystal" },
    "minecraft:ender_eye",
  ...
  event.replaceInput(
    { input: "twilightforest:raven_feather" },
  ...
  event.replaceInput(
    { output: "cyclic:storage_bag" },
    "minecraft:diamond",
    "sophisticatedstorage:advanced_hopper_upgrade"
  );

  event.replaceInput(
    { output: "cyclic:detector_entity" },
    "minecraft:diamond",
  ...
  event.replaceInput(
    { output: "bluepower:blulectric_cable" },
    "bluepower:blue_alloy_ingot",
  ...
  event.replaceInput(
    { id: "bluepower:diamond_drawplate" },
    "minecraft:diamond",
    "minecraft:emerald"
  );
