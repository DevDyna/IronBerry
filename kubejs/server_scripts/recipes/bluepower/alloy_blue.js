ServerEvents.recipes((event) => {
  ...
  //------------------------------------//
  alloy(
    ["minecraft:coal", "minecraft:raw_iron"],
    [2, 4],
  ...
  alloy(
    ["bluepower:teslatite_dust", "minecraft:iron_ingot"],
    [4, 2],
  ...
  alloy(
    ["create:brass_ingot", "bluepower:purple_alloy_ingot"],
    [4, 1],
  ...
  alloy(
    ["bluepower:blue_doped_wafer", "bluepower:red_doped_wafer"],
    [1, 1],
  ...
  alloy(
    ["minecraft:glowstone_dust", "create:brass_ingot"],
    [2, 1],
  ...
  alloy(
    ["bluepower:infused_teslatite_dust", "minecraft:copper_ingot"],
    [2, 1],
    "thermal:lead_ingot",
    4
  );

  alloy(["#tombstone:magic_tablets"], [1], "tombstone:strange_tablet", 1);

  alloy(
    ["minecraft:sugar", "minecraft:stick", "reactive:stardust"],
    [4, 1, 1],
    "kubejs:iron_rod",
    1
  );
  ...
  alloy(
    ["reactive:quartz_bottle", "minecraft:glass_bottle"],
    [9, 9],
  ...
  alloy(
    ["minecraft:bone_block", "minecraft:sculk"],
    [3, 3],
  ...
  alloy(
    ["kubejs:ritual_tablet", "kubejs:processor"],
    [1, 1],
  ...
  alloy(
    ["minecraft:stone_slab", "minecraft:smooth_stone_slab", "quark:blank_rune"],
    [1, 1, 1],
    "kubejs:ritual_tablet",
    8
  );

  alloy(
    ["kubejs:patina", "hostilenetworks:twilight_prediction"],
    [1, 1],
    "hostilenetworks:empty_prediction",
    1
  );
  ...
  alloy(
    ["twilightforest:knightmetal_ingot", "twilightforest:ironwood_ingot"],
    [1, 1],
    "kubejs:pre_compressed",
    4
  );
  ...
  alloy(
    ["thermal:silver_ingot", "minecraft:gold_ingot"],
    [1, 1],
    "thermal:electrum_ingot",
    2
  );
  ...
  alloy(
    ["minecraft:glowstone_dust", "minecraft:grass"],
    [1, 1],
  ...
  alloy(
    ["minecraft:coal", "bluepower:teslatite_dust", "minecraft:redstone"],
    [1, 2, 1],
    "bluepower:battery",
    2
  );
  ...
  alloy(
    ["bluepower:blue_doped_wafer", "bluepower:blue_alloy_ingot"],
    [2, 1],
  ...
  alloy(
    ["minecraft:ender_pearl", "rftoolsbase:dimensionalshard"],
    [1, 1],
  ...
  alloy(
    ["#ironberry:rftools_modules", "minecraft:stick"],
    [1, 1],
    "kubejs:base_module",
    1
  );
  ...
  alloy(
    ["#ironberry:rftools_machines", "minecraft:stick"],
    [1, 1],
  ...
  alloy(
    ["#ironberry:rftools_plates", "minecraft:stick"],
    [1, 1],
    "rftoolsbase:machine_base",
    1
  );
  ...
  alloy(
    ["bluepower:red_alloy_ingot", "minecraft:quartz"],
    [1, 4],
    "create:rose_quartz",
    4
  );
  alloy(
    ["create:rose_quartz", "bluepower:silicon_wafer"],
    [16, 1],
  ...
  alloy(
    ["minecraft:andesite", "create:zinc_nugget"],
    [1, 1],
