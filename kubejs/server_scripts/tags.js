...
ServerEvents.tags('item', event => {
    ...
    event.add('ironberry:mid_ingots', ['thermal:tin_ingot', 'mekanism:ingot_osmium', 'nuclearcraft:thorium_ingot', 'mekanism:ingot_uranium', 'nuclearcraft:boron_ingot', 'nuclearcraft:magnesium_ingot'])
...
ServerEvents.tags('block', event => {
    ...
    let roots_pedestals = ['rootsclassic:mundane_standing_stone', 'rootsclassic:attuned_standing_stone', 'rootsclassic:vacuum_standing_stone', 'rootsclassic:repulsor_standing_stone', 'rootsclassic:accelerator_standing_stone', 'rootsclassic:aesthetic_standing_stone', 'rootsclassic:entangler_standing_stone', 'rootsclassic:igniter_standing_stone', 'rootsclassic:grower_standing_stone', 'rootsclassic:healer_standing_stone']
    tags.forEach(tag=>{
