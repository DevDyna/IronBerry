...
global.whitelistGasses = [
  ...
  "kubejs:micio",
  "kubejs:zicio",
  "kubejs:radio_uranium",
  "kubejs:radio_thorium",
  "kubejs:fuel_mixture",
  "kubejs:pyrotheum",
  "kubejs:exosteam",
];
...
global.disabledItem = [
  'thermal:slime_grenade', 'thermal:phyto_grenade', 'thermal:fire_tnt', 'thermal:ice_tnt', 'thermal:lightning_tnt', 'thermal:earth_tnt', 'thermal:ender_tnt', 'thermal:glowstone_tnt', 'thermal:redstone_tnt', 'thermal:slime_tnt', 'thermal:phyto_tnt', 'thermal:explosive_grenade', 'thermal:fire_grenade', 'thermal:ice_grenade', 'thermal:lightning_grenade', 'thermal:earth_grenade', 'thermal:ender_grenade', 'thermal:glowstone_grenade', 'thermal:redstone_grenade',
  ...
  "pedestals:augment_pedestal_transfertoggle",
  "pedestals:tool_augments_transfertoggle",
  "sophisticatedstorage:debug_tool",
  "supplementaries:quiver",
  "thermal:raw_tin",
  "thermal:lock",
  "thermal:rf_potato",
  "thermal:cooked_mushroom",
  ...
  "ten3:powered_tin_plate",
  "thermal:hearty_stew",
  "thermal:stuffed_pepper",
  "thermal:tea_block",
  "thermal:coffee_block",
  "thermal:peanut_block",
  "thermal:rice_block",
  ...
  "bluepower:paint_brush_light_gray",
  "bluepower:paint_brush_gray",
  "bluepower:paint_brush_pink",
  "bluepower:paint_brush_lime",
  "bluepower:paint_brush_yellow",
  "bluepower:paint_brush_light_blue",
  "bluepower:paint_brush_magenta",
  "bluepower:paint_brush_orange",
  "bluepower:paint_brush_white",
  "bluepower:paint_brush_blank",
  "bluepower:paint_can_black",
  "bluepower:paint_can_red",
  "bluepower:paint_can_green",
  "bluepower:paint_can_brown",
  "bluepower:paint_can_blue",
  "bluepower:paint_can_purple",
  "bluepower:paint_can_cyan",
  "bluepower:paint_can_light_gray",
  "bluepower:paint_can_gray",
  "bluepower:paint_can_pink",
  "bluepower:paint_can_lime",
  "bluepower:paint_can_yellow",
  "bluepower:paint_can_light_blue",
  "bluepower:paint_can_magenta",
  "bluepower:paint_can_orange",
  "bluepower:paint_can_white",
  "bluepower:paint_can_blank",
  "bluepower:flax_seeds",
  "bluepower:tungsten_raw",
  "bluepower:silver_raw",
  ...
  "pedestals:upgrade_pedestal_rfcharger",

  "ten3:chlorium_nugget",
  "nuclearcraft:dense_nitrogen_collector",
  "nuclearcraft:compact_nitrogen_collector",
  "nuclearcraft:nitrogen_collector",
  "nuclearcraft:dense_helium_collector",
  "nuclearcraft:compact_helium_collector",
  "nuclearcraft:helium_collector",
  "nuclearcraft:dense_water_collector",
  "nuclearcraft:compact_water_collector",
  "nuclearcraft:lava_collector",
  "nuclearcraft:water_collector",
  "thermal:rubberwood_chest_boat",
  "thermal:rubberwood_boat",
  "inventorypets:blue_screen",
  "inventorypets:xerox_parc_gui",
  "inventorypets:windows_xp",
  "inventorypets:windows_mojave",
  "inventorypets:windows_me",
  "inventorypets:windows_31",
  "inventorypets:windows_8",
  "inventorypets:windows_7",
  "inventorypets:start_button",
  "bluepower:paint_brush_black",
  "bluepower:paint_brush_red",
  "bluepower:paint_brush_green",
  "bluepower:paint_brush_brown",
  "bluepower:paint_brush_blue",
  "bluepower:paint_brush_purple",
  "bluepower:paint_brush_cyan",
  "thermal:raw_silver",
  "thermal:silver_gear",
  ...
  "bluepower:rubber_log",
  "bluepower:rubber_leaves",
  "bluepower:rubber_sapling",
  "bluepower:tungsten_deepslate",
  "bluepower:silver_deepslate",
  "bluepower:green_sapphire_deepslate",
  "bluepower:sapphire_deepslate",
  "bluepower:ruby_deepslate",
  "bluepower:teslatite_deepslate",
  "bluepower:tungsten_ore",
  "bluepower:silver_ore",
  "bluepower:green_sapphire_ore",
  "bluepower:sapphire_ore",
  "bluepower:ruby_ore",
  "bluepower:teslatite_ore",
  ...
  "inventorypets:pet_sated_double_chest",
  ...
  "twilightforest:peacock_feather_fan",
  ...
  "bluepower:zinc_tiny_dust",
  "bluepower:zinc_ore_purified",
  "bluepower:zinc_ore_crushed",
  "bluepower:zincplate",
  "bluepower:zinc_ore",
  ...
  "thoriumreactors:progressive_fluid_tank",
  "thoriumreactors:generic_fluid_tank",
  "thoriumreactors:simple_fluid_tank",
  "thoriumreactors:creative_energy_tank",
  "thoriumreactors:creative_energy_tank",
  "thoriumreactors:progressive_energy_tank",
  "thoriumreactors:generic_energy_tank",
  "thoriumreactors:simple_energy_tank",
  "thoriumreactors:thorium_crafting_table",
  "thoriumreactors:fluorite",
  "thoriumreactors:yellow_cake",
  "thoriumreactors:cobalt_nugget",
  "thoriumreactors:cobalt_ingot",
  "thoriumreactors:fluorite_nugget",
  "thoriumreactors:fluorite_ingot",
  "thoriumreactors:uranium_nugget",
  "thoriumreactors:uranium_ingot",
  "thoriumreactors:aluminum_nugget",
  "thoriumreactors:aluminum_ingot",
  "thoriumreactors:nickel_nugget",
  "thoriumreactors:nickel_ingot",
  "thoriumreactors:manganese_nugget",
  "thoriumreactors:steel_nugget",
  "thoriumreactors:steel_ingot",
  "thoriumreactors:graphite_crystal",
  "thoriumreactors:graphite_nugget",
  ...
  "thoriumreactors:fluorite_block",
  "thoriumreactors:graphite_block",
  "thoriumreactors:uranium_block",
  "thoriumreactors:cobalt_block",
  "thoriumreactors:aluminum_block",
  "thoriumreactors:titanium_block",
  "thoriumreactors:chromium_block",
  "thoriumreactors:manganese_block",
  ...
  "thoriumreactors:deepslate_pyrochlor_ore",
  "thoriumreactors:pyrochlor_ore",
  "thoriumreactors:deepslate_bauxite_ore",
  "thoriumreactors:bauxite_ore",
  "thoriumreactors:deepslate_titanic_iron_ore",
  "thoriumreactors:titanic_iron_ore",
  "thoriumreactors:deepslate_nickel_ore",
  "thoriumreactors:nickel_ore",
  ...
  "thoriumreactors:steel_block",
  "thoriumreactors:salt_melter_block",
  "thoriumreactors:fluid_centrifuge_block",
  "thoriumreactors:electrolytic_salt_separator",
  "thoriumreactors:fluid_evaporation_block",
  "thoriumreactors:decomposer_block",
  "thoriumreactors:blast_furnace_block",
  "thoriumreactors:uranium_oxidizer_block",
  "thoriumreactors:concentrator_block",
  "thoriumreactors:fluid_enricher_block",
  "thoriumreactors:generator_block",
  "thoriumreactors:crystallizer_block",
  ...
  "nuclearcraft:hazmat_chest",
  "nuclearcraft:tough_chest",
  "nuclearcraft:hazmat_pants",
  "nuclearcraft:tough_pants",
  "nuclearcraft:hazmat_boots",
  ...
  "nuclearcraft:tough_alloy_plate",
  ...
  "nuclearcraft:thermoconducting_plate",
  ...
  "nuclearcraft:californium_rtg",
  "nuclearcraft:plutonium_rtg",
  "nuclearcraft:americium_rtg",
  ...
  "nuclearcraft:turbine_steel_rotor_blade",
  ...
  "nuclearcraft:money_for_nothing",
  ...
  "nuclearcraft:end_of_the_world",
  "nuclearcraft:hyperspace",
  ...
  "nuclearcraft:turbine_bearing",
  "nuclearcraft:turbine_casing",
  "nuclearcraft:dps",
  "nuclearcraft:heavy",
  "nuclearcraft:medium",
  "nuclearcraft:light",
  "nuclearcraft:wanderer",
  "nuclearcraft:turbine_extreme_rotor_blade",
  "#forge:isotopes",
  "#nuclearcraft:reactor_fuel",
  "ten3:nickel_block",
  "ten3:nickel_ingot",
  "ten3:nickel_nugget",
  "ten3:iron_gear",
  ...
  "ten3:cable",
  "ten3:pipe_black",
  "ten3:deep_nickel_ore",
  "ten3:raw_tin_block",
  "ten3:raw_nickel_block",
  "ten3:engine_extraction",
  "ten3:engine_metal",
  "ten3:engine_biomass",
  "ten3:engine_solar",
  "ten3:machine_beacon_simulator",
  "ten3:machine_mob_ripper",
  "ten3:machine_quarry",
  "ten3:cell",
  "ten3:pipe",
  "ten3:deep_tin_ore",
  ...
  "supplementaries:integrateddynamics/sign_post_menril",
  "supplementaries:integrateddynamics/hanging_sign_menril",
  ...
  "thoriumreactors:blasted_iron_chest_block",
  ...
  "inventorypets:pet_sated_chest",
  "inventorypets:pet_sated_double_chest",
  "pedestals:filter_enchantedcount",
  "pedestals:tool_tagtool",
  "pedestals:tool_toolswapper",
  "pedestals:tool_devtool",
  "pedestals:tool_manifesttool",
  "pedestals:workcard_area",
  "pedestals:workcard_locations",
  "pedestals:workcard_pedestals",
  "pedestals:filter_tag",
  "pedestals:filter_base",
  "pedestals:filter_item",
  "pedestals:tool_linkingtool",
  "pedestals:tool_linkingtoolbackwards",
  "pedestals:filter_enchanted",
  "pedestals:filter_durability",
  "pedestals:filter_itemstack",
  "pedestals:tool_upgradetool",
  "pedestals:tool_filtertool",
  "pedestals:tool_worktool",
  "pedestals:filter_restricted",
  "pedestals:filter_mod",
  "pedestals:filter_food",
  "pedestals:filter_enchantedfuzzy",
  "pedestals:filter_enchantedexact",
  "pedestals:augment_pedestal_t3_storage",
  "pedestals:augment_pedestal_t1_speed",
  "pedestals:augment_pedestal_t2_speed",
  "pedestals:augment_pedestal_t3_speed",
  "pedestals:augment_pedestal_t4_speed",
  "pedestals:augment_pedestal_t1_range",
  "pedestals:augment_pedestal_t2_range",
  "pedestals:mechanical_storage_xp",
  "pedestals:modifier_getter",
  "pedestals:filter_tag_machine",
  "pedestals:tag_getter",
  "pedestals:filter_blocksonclickexact",
  "pedestals:filter_blocksonclickfuzzy",
  "pedestals:upgrade_pedestal_base",
  "pedestals:upgrade_pedestal_import",
  "pedestals:upgrade_pedestal_export",
  "pedestals:upgrade_pedestal_magnet",
  "pedestals:upgrade_pedestal_breaker",
  "pedestals:upgrade_pedestal_placer",
  "pedestals:upgrade_pedestal_filler",
  "pedestals:upgrade_pedestal_quarry",
  "pedestals:upgrade_pedestal_fan",
  "pedestals:upgrade_pedestal_breeder",
  "pedestals:upgrade_pedestal_milker",
  "pedestals:upgrade_pedestal_sheerer",
  "pedestals:upgrade_pedestal_drain",
  "pedestals:upgrade_pedestal_pump",
  "pedestals:upgrade_pedestal_dropper",
  "pedestals:upgrade_pedestal_fluidconverter",
  "pedestals:upgrade_pedestal_void",
  "pedestals:upgrade_pedestal_planter",
  "pedestals:upgrade_pedestal_harvester",
  "pedestals:upgrade_pedestal_chopper",
  "pedestals:upgrade_pedestal_bottler",
  "pedestals:upgrade_pedestal_smoker",
  "pedestals:augment_pedestal_t2_storage",
  "pedestals:filter_item_machine",
  "pedestals:filter_itemstack_machine",
  "pedestals:tool_augments_speed",
  "pedestals:tool_augments_capacity",
  "pedestals:tool_augments_storage",
  "pedestals:tool_augments_range",
  "pedestals:tool_augments_diffuser",
  "pedestals:tool_augments_roundrobin",
  "pedestals:tool_augments_collide",
  "pedestals:upgrade_pedestal_unbottler",
  "pedestals:upgrade_pedestal_packager",
  "pedestals:augment_pedestal_t1_storage",
  "pedestals:augment_pedestal_t4_capacity",
  "pedestals:augment_pedestal_t3_capacity",
  "pedestals:augment_pedestal_t1_capacity",
  "pedestals:augment_pedestal_renderdiffuser",
  "pedestals:upgrade_pedestal_attacker",
  "pedestals:upgrade_pedestal_fertilizer",
  "pedestals:upgrade_pedestal_hiveharvester",
  "pedestals:upgrade_pedestal_recycler",
  "pedestals:upgrade_pedestal_unpackager",
  "pedestals:upgrade_pedestal_crafter",
  "pedestals:upgrade_pedestal_modifications",
  "pedestals:upgrade_pedestal_smelter",
  "pedestals:mechanical_storage_energy",
  "pedestals:mechanical_storage_fluid",
  "pedestals:mechanical_storage_item",
  "pedestals:augment_pedestal_t4_range",
  "pedestals:augment_pedestal_t3_range",
  "pedestals:augment_pedestal_t2_capacity",
  "pedestals:augment_pedestal_nocollide",
  "pedestals:augment_pedestal_roundrobin",
  "pedestals:upgrade_pedestal_generator",
  "pedestals:upgrade_pedestal_blaster",
  "pedestals:augment_pedestal_t4_storage",
  "pedestals:mechanical_storage_dust",
  ...
  "jetboots:engine_upgrade",
  "jetboots:muffled_upgrade",
  "jetboots:underwater_upgrade",
  "jetboots:thruster_upgrade",
  "jetboots:jetboots",
...
global.fish_food = //[
  Item.of(
    ...
    '{Damage:0,display:{Name:\'{"text":"Fishing","color":"gold","italic":false}\'}}'
  );
// "thermal:aquachow",
// "thermal:junk_net",
// "thermal:deep_aquachow",
