...
EnApp('minecraft:lectern',['kubejs:scroll_discontinuity','minecraft:bookshelf','minecraft:bookshelf','minecraft:bookshelf','minecraft:bookshelf'],'ars_nouveau:storage_lectern',0,false)
EnApp('minecraft:glass_bottle',['reactive:stardust','reactive:stardust','reactive:stardust','reactive:stardust'],'ars_nouveau:jar_of_light',0,false)
EnApp('minecraft:glass_bottle',['cyclic:trash','ars_nouveau:deny_scroll','ars_nouveau:allow_scroll'],'ars_nouveau:void_jar',0,false)
...
EnApp('ars_nouveau:splash_flask_cannon',['reactive:stardust','minecraft:feather','reactive:stardust'],'ars_nouveau:lingering_flask_cannon',0,false)
...
EnApp('ars_nouveau:relay',['ars_nouveau:relay_collector','ars_nouveau:relay_deposit'],'ars_nouveau:relay_splitter',0,false)
